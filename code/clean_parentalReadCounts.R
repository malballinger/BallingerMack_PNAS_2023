...
# This script filters and subsets the metadata file: data/raw/all_parents_counts.txt
# The generated subsets (matrices) are used for downstream analyses in BallingerMack_PNAS_2022.
